...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="bt btn-success" href="/acceuil1">back</a>
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h1 class="display-5 fw-bolder">{{ $pub->NOM }}</h1>
                    <div class="fs-5 mb-5">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <input hidden="texte" name="idu" value="{{ $pub->IDC }}" class="form-control">
                                      <input hidden="texte" name="idP" value="{{ $pub->ID_PUBLICATION }}" class="form-control">
